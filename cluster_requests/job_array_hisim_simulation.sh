...
python /fast/home/k-rieck/HiSim-Building-Sizer/building_sizer/hisim_simulation_no_utsp.py "$input_param1" "$input_param2" "$input_param3" "$input_param4"

# # Run the Python script and capture the output
# python_output=$(python /fast/home/k-rieck/HiSim-Building-Sizer/building_sizer/hisim_simulation_no_utsp.py "$input_param1" "$input_param2" "$input_param3" "$input_param4")

# # Print the captured output so that subprocess in the main Python script can receive it
# echo "$python_output"
